...
def main():
    ...
    mp4_bitrate = '5M'
    random_seed = 404
    mp4_file = '/mnt/slow1/stylegan/videos/random_grid_%s.mp4' % random_seed
    minibatch_size = 8
    ...
    # Generate video.
    import moviepy.editor
    mp4_file = '/mnt/slow1/stylegan/videos/interpolate.mp4'
    mp4_codec = 'libx264'
    mp4_bitrate = '5M'
    ...
    # Generate video.
    import moviepy.editor
    mp4_file = '/mnt/slow1/stylegan/videos/fine_%s.mp4' % (random_seed)
    mp4_codec = 'libx264'
    mp4_bitrate = '5M'
