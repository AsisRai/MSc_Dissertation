...
if 1:
    ...
    # Dataset.
    desc += '-stylegan_generated_faces';     dataset = EasyDict(tfrecord_dir='/mnt/slow3/stylegan_format_faces/', resolution=512);                 train.mirror_augment = True
    ...
    sched.G_lrate_dict = {128: 0.0015, 256: 0.002, 512: 0.001, 1024: 0.001}
    #sched.D_lrate_dict = {128: 0.0015, 256: 0.002, 512: 0.002, 1024: 0.002}
