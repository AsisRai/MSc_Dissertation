...
def training_loop(
    ...
    resume_run_id           = '/mnt/slow1/stylegan/results/00011-sgan-stylegan_generated_faces-4gpu/network-snapshot-021980.pkl',     # Run ID or network pkl to resume training from, None = start from scratch.
    resume_snapshot         = None,     # Snapshot index to resume training from, None = autodetect.
    resume_kimg             = 21980,    #0.0 # Assumed training progress at the beginning. Affects reporting and training schedule.
